...
#[endpoint(
    ...
    responses(
        (status_code = 200, body = ResponseSuccess<PaginateResultVO<KindMasterVO>>, description = consts::RESPONSE_DESCRIPTION_SUCCESS),
...
#[endpoint(
    ...
    tags("Mate模块/管理端/Kind管理"),
    responses(
        (status_code = 200, body = ResponseSuccess<KindFormOptionVO>, description = consts::RESPONSE_DESCRIPTION_SUCCESS),
        (status_code = 401, body = ResponseError, description = consts::RESPONSE_DESCRIPTION_UNAUTHORIZED)
    )
)]
...
#[endpoint(
    ...
    tags("Mate模块/管理端/Kind管理"),
    responses(
        (status_code = 200, body = ResponseSuccess<KindQueryOptionVO>, description = consts::RESPONSE_DESCRIPTION_SUCCESS),
        (status_code = 401, body = ResponseError, description = consts::RESPONSE_DESCRIPTION_UNAUTHORIZED)
    )
)]
...
#[endpoint(
    ...
    tags("Mate模块/管理端/Kind管理"),
    responses(
        (status_code = 200, body = ResponseSuccess<KindMasterVO>, description = consts::RESPONSE_DESCRIPTION_SUCCESS),
